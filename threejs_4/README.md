...
for auto-reload of browser on edit change, see entry in:   
/workspaces/threejs_4cspace/threejs_4/vite.config.ts

---- copied from other project, needs to be edited for this one -----   
  

## cd to folder zzzz to begin!!!
## my notes 
