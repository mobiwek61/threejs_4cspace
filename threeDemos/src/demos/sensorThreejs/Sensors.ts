...
function DoOrientTest() {
    ...
    // run this once:
        ...
        try {
          ...
          sensorOrien.addEventListener("reading", () => {
              ...
              // show quat as text
              // if (oldQuatDisp != QuatAreFun.showQuat(sensorOrien.quaternion)) {
              //   //console.log('afweefwe')
              //   oldQuatDisp = QuatAreFun.showQuat(sensorOrien.quaternion)
              ...
              //   document.querySelector('#quat')!.textContent = oldQuatDisp
              // }
          });
          sensorOrien.start();
    ...
    return(<div style={ CSS_border_width('9px', 'dotted green') }>
      ...
      todo: convert to a function returning a div with the 3d text and lighting thing 
      then return it in this div returned to the main menu for display... 
